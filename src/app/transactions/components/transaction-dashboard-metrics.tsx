...
import { IconArrowsUpDown, IconBusinessplan, IconTrendingDown, IconTrendingUp } from "@tabler/icons-react";
    ...
    return (
        <div className="grid sm:grid-cols-1 md:grid-4 lg:grid-cls-4 xl:grid-cols-4 2xl:grid-cols-4 gap-3 sm:gap-3 mt-4">
            {metrics.map((metric, idx) => (
                <Card className="p-4 rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-200 border border-accent-foreground" key={idx}>
